<template>
    <div>
        <BaseH2>This is the SVG tab</BaseH2>
        <div class="content space-y-4 md:w-1/2">
            <p>
                SVG images can be labelled with a
                <code>&lt;title&gt;</code> element and described by a
                <code>&lt;desc&gt;</code> element.
            </p>
            <p>
                <code>&lt;desc&gt;</code> should be used for more complex
                graphics, but note that screen readers don't necessarily read
                it.
            </p>
            <p>
                In this case <code>aria-labelledby</code> has been used with
                referential ids pointing to both the
                <code>&lt;title&gt;</code> and
                <code>&lt;desc&gt;</code> elements in order to ensure that both
                are read.
            </p>
            <p>
                Source: an old
                <a
                    ...
                    class="border-b border-emerald-950/0 font-bold transition-colors duration-200 hover:border-emerald-950"
        ...
        <svg
            ...
            version="1"
            viewBox="0 0 720 800"
            aria-labelledby="cat-svg-title-id cat-svg-desc-id"
        >
            <title id="cat-svg-title-id">A cute cat</title>
            <desc id="cat-svg-desc-id">This is an image of a cute cat.</desc>
            <path
                id="tail"
                data-name="tail"
                class="cls-1"
            ...
            <g id="head">
                ...
                <g id="mouth">
                    ...
                    <path
                        class="cls-9"
                        d="M300.7,204.5a65.16,65.16,0,0,1-8,32"
                        transform="translate(-9.7 -9.3)"
                    />
                </g>
                <path
